          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu animated flipInX">
                <li class="user-body">
                  ...
                  <a class="dropdown-item" href="{{ route('login') }}"><i class="ti-lock text-muted me-2"></i> Cerrar
                    sesión</a>
                </li>
              </ul>
            </li>
            <li class="btn-group nav-item d-lg-inline-flex d-none">
              <a href="#" data-provide="fullscreen"
                class="waves-effect waves-light nav-link full-screen btn-warning-light" title="Pantalla completa">
                <i class="icon-Position"></i>
              </a>
            </li>
            <!-- Notifications -->
            <li class="dropdown notifications-menu">
              <a href="#" class="waves-effect waves-light dropdown-toggle btn-info-light" data-bs-toggle="dropdown"
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li class="treeview {{ request()->routeIs('pacientes.*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{ route('pacientes.index') }}"><i class="icon-Commit"><span class="path1"></span><span
                          class="path2"></span></i>Lista de Pacientes</a></li>
                </ul>
              </li>
              ...
              <li class="treeview {{ request()->routeIs('doctores.*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{ route('doctores.index') }}"><i class="icon-Commit"><span class="path1"></span><span
                          class="path2"></span></i>Lista de Doctores</a></li>
                </ul>
              </li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="{{ route('registro') }}"><i class="icon-Commit"><span class="path1"></span><span
                          class="path2"></span></i>Registrarse</a></li>
                </ul>
              </li>
            </ul>
