            ...
            <form method="POST" action="{{ route('servicios.update', $servicio) }}">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input name="precio" value="{{ old('precio', $servicio->precio) }}" class="form-control" type="number" step="0.01" min="0">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label">Orden</label>
                        <input name="orden" value="{{ old('orden', $servicio->orden) }}" class="form-control" type="number" min="0">
                    </div>
